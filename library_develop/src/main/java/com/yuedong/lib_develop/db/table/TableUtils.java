...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.yuedong.lib_develop.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.yuedong.lib_develop.db.table.Id>();

    /* package */
    static synchronized com.yuedong.lib_develop.db.table.Id getId(Class<?> entityType) {
        ...
        com.yuedong.lib_develop.db.table.Id id = new com.yuedong.lib_develop.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.yuedong.lib_develop.db.table.Id id = getId(entityType);
