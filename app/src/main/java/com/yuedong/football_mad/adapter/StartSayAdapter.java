       ...
       if(bean.getInterest() == 1){
           ...
           imageView3.setOnClickListener(new View.OnClickListener() {
               ...
               public void onClick(View v) {
                   ...
                   post.put("starid",bean.getAuthorid());
                   RequestHelper.post(Constant.URL_INTEREST_STAR, post, BaseResponse.class, false, false, new VolleyNetWorkCallback() {
                       @Override
                       ...
                       public void onNetworkError(String tag, VolleyError error) {
                           if (error != null)
                               T.showShort(mCon, error.getMessage());
                       }
                   });
                   post = null;
               }
